...
#ifndef IMAGEQUALITYDEV_H
#define IMAGEQUALITYDEV_H
...
class ImageQualityDev: public OutputDev {
public:
  ...
  ImageQualityDev(double phisical_width, PopplerImageMapping* img_mapping, v8::Local<v8::Object> out );

  // Destructor.
  virtual ~ImageQualityDev();

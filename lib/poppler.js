(function () {
    ...
    var modulePath = existsSync('../build/Release/poppler')
        ? '../build/Release/poppler'
        : existsSync('../build/default/poppler')
            ? '../build/default/poppler'
            : existsSync('../build/Debug/poppler')
                ? '../build/Debug/poppler
                : null;
    
    if (!modulePath) {
        throw new Error("No module found (tried ../build/Release/poppler, ../build/default/poppler, ../build/Debug/poppler)");
    }
